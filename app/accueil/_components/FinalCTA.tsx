  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-20" style={{ background: "#010e2e" }}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at center, #056cf21a 0%, transparent 70%)",
        }}
      />

      <div className="relative mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl" style={{ background: "linear-gradient(135deg, #056cf2, #9dc7ff)" }}>
